...
Num_atomo_4 = Num_atomo_T * Prop_4;
Num_atomo_5 = Num_atomo_T * Prop_5;
...
r0 = 1e-10:0.01e-10:40e-10;
U0 = (- A_promedio./r0 + B_promedio./(r0.^2)); %*6.022e3; % Esto estaría en unidades de kJ/mol.
hold on
plot (r0/1e-10, U0/1.602e-19, 'LineWidth', 2.5);
r0_min = 2*B_promedio/A_promedio;
U0_min = - A_promedio/r0_min + B_promedio/(r0_min^2);
plot (r0_min/1e-10,U0_min/1.602e-19,'.', 'MarkerSize', 40)
xlabel ('r (10^{-10}m)','FontSize', 20)
ylabel ('U_{Promd} (eV)','FontSize', 20)
set(gca, 'FontSize', 18);
grid on
hold off
...
for x = 0:Parmtr_ret:N_celda_max*Parmtr_ret
    for y = 0:Parmtr_ret:N_celda_max*Parmtr_ret
        for z = 0:Parmtr_ret:N_celda_max*Parmtr_ret
            ...
            elseif Num_aleatorio < (Prop_1+Prop_2+Prop_3)
                % Tipo 3.
                Tipo_atom = 3;
                Color_esq = 'b';
                Radio_esq = Radio_3;
            ...
            elseif Num_aleatorio < (Prop_1+Prop_2+Prop_3+Prop_4)
                % Tipo 4.
                Tipo_atom = 4;
                Color_esq = 'y';
                Radio_esq = Radio_4;
            ...
            Prop_4 = Num_atomo_4/Num_atomo_T;
            Prop_5 = Num_atomo_5/Num_atomo_T;
