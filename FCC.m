...
distancia_entre_esquinas = 2 * sqrt(2) * radio_maximo;

% Distancia entre el centro y las esquinas de la celda
distancia_centro_esquinas = sqrt(3) * sqrt(2) * radio_maximo;
...
% Bucle para colocar el átomos (1,1,0)
for x = 0:distancia_entre_esquinas:3*distancia_entre_esquinas
    for y = 0:distancia_entre_esquinas:3*distancia_entre_esquinas
        for z = 0:distancia_entre_esquinas:3*distancia_entre_esquinas
            % Posición del átomo en el centro del cubo
            pos_centro_cubo = [x, y, z] + distancia_entre_esquinas * (1/2) * [1, 1, 0];
...
% Bucle para colocar el átomos (1,0,1)
for x = 0:distancia_entre_esquinas:3*distancia_entre_esquinas
    for y = 0:distancia_entre_esquinas:3*distancia_entre_esquinas
        for z = 0:distancia_entre_esquinas:3*distancia_entre_esquinas
            % Posición del átomo en el centro del cubo
            pos_centro_cubo = [x, y, z] + distancia_entre_esquinas * (1/2) * [1, 0, 1];
...
% Bucle para colocar el átomos (0,1,1)
for x = 0:distancia_entre_esquinas:3*distancia_entre_esquinas
    for y = 0:distancia_entre_esquinas:3*distancia_entre_esquinas
        for z = 0:distancia_entre_esquinas:3*distancia_entre_esquinas
            % Posición del átomo en el centro del cubo
            pos_centro_cubo = [x, y, z] + distancia_entre_esquinas * (1/2) * [0, 1, 1];
