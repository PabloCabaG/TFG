...
% Código para generar muchos valores de U_T y ver como se distribuyen en un
% histograma.
...
Rep_max = 1000;
Matriz_U_T = zeros(Rep_max,2);

for Rep_U_T = 1:Rep_max
...
%                 surf(x_sphere, y_sphere, z_sphere, 'FaceColor', Color_centro, 'EdgeColor', 'none');
    ...
    Matriz_U_T(Rep_U_T,:) = [Rep_U_T, U_T];
