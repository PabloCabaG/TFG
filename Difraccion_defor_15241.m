...
e = -0.005;
defor = (1 + e);
Info_atomo_defor = [Info_atomo(:,1), Info_atomo(:,2), Info_atomo(:,3), Info_atomo(:,4), Info_atomo(:,5) * defor, Info_atomo(:,6) * defor, Info_atomo(:,7)];
    ...
    for x = 0 : 4 : 4*Rep
        for y = 0 : 4 : 4*Rep
            for j = 1 : N/2
                ...
                dk_x = k_x_prima - k_x;
                dk_y = k_y_prima - k_y;
                x_rljd = (Info_atomo_defor (j,5) + x * defor) * Parmtr_ret;
                y_rljd = (Info_atomo_defor (j,6) + y * defor) * Parmtr_ret;
